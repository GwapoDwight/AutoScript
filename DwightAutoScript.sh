...
./configure && make && sudo make install && sudo add-apt-repository ppa:neurobin/ppa && sudo apt-get -y update && sudo apt-get install shc && sudo apt-get -y upgrade && apt-get install expect -y
